...
$h$-dimensionalen "Gruppenelement-Vektorraum" auf.
Jeder Vektor in diesem Raum haben drei Indizes, $i, \mu, \nu$.
...
Der Charakter $\chi^i(R)$ einer Darstellung $\symup{\Gamma}^i(R)$ ist durch 
\begin{equation*}
